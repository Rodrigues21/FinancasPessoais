...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Adicionar Conta')); ?></div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="saldo_abertura" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Saldo Abertura')); ?></label>

                            <div class="col-md-6">
                                <input id="saldo_abertura" type="text" class="form-control <?php $__errorArgs = ['saldo_abertura'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a class="btn btn-danger " href="<?php echo e(route('contas')); ?>">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\ainet\FinancasPessoais\resources\views/contas/create.blade.php ENDPATH**/ ?>