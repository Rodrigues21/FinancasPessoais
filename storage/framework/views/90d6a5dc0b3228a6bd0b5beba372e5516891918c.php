                                ...
                                <td style="width:13.4%">  
                                    <div class="btn-group" >            
                                        ...
                                        <div class="column" style= "margin-right: 5px;  margin-top: 5px;">                                
                                            <a  href="<?php echo e(route('movimento.edit', $mov)); ?>" title="Editar Movimento" class="btn btn-secondary" role="button" aria-pressed="true" ><span class="fa fa-pencil"></span></a>                                    
                                        </div>
